  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md mx-4">
        {/* Card */}
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl mt-8 mb-8">
          {/* Logo */}
          <div className="text-center mb-8">
            ...
            <p className="text-blue-200/60 text-sm mt-1">Join the Return Logistics Tracking System</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-blue-200/50 mt-1.5 ml-1">Must be at least 8 chars with uppercase, lowercase & digit.</p>
            </div>
